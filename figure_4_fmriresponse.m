...
for roi = 1:5 %
    ...
    P(roi,:) =  [statcomparemean(nanmean(actn(ismal == 0,:),2), nanmean(actnn(ismal == 0,:),2)); statcomparemean(nanmean(actn(ismal == 1,:),2), nanmean(actnn(ismal == 1,:),2)); statcomparemean(nanmean(actn,2), nanmean(actnn,2))];
